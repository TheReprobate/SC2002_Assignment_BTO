...
public class HdbManagerServiceManager {
    ...
    /**
     * Constructs an {@code HdbManagerServiceManager} with the necessary HDB Manager service instances.
     *
     * @param applicationService The service for handling BTO application operations for HDB Managers.
     * @param enquiryService     The service for handling enquiry operations for HDB Managers.
     * @param projectService     The service for handling project related operations for HDB Managers.
    ...
    public HdbManagerBtoApplicationService getApplicationService() { return applicationService; }
