...
public class HdbOfficerServiceManager extends ApplicantServiceManager{
    ...
    /**
     * Constructs an {@code HdbOfficerServiceManager} with the necessary HDB Officer service instances.
     *
     * @param applicationService The service for handling BTO application operations for HDB Officers.
     * @param enquiryService     The service for handling enquiry operations for HDB Officers.
     * @param projectService     The service for handling project related operations for HDB Officers.
